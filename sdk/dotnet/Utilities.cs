...
namespace Pulumi.Kafkacluster
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pulumi-pequod/pequod-mlc-kafkacluster";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Kafkacluster.version.txt");
    ...
    internal sealed class KafkaclusterResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public KafkaclusterResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
