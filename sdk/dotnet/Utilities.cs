...
namespace Pulumi.K8sdatadog
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pulumi-pequod/pequod-mlc-k8sdatadog";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.K8sdatadog.version.txt");
    ...
    internal sealed class K8sdatadogResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public K8sdatadogResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
